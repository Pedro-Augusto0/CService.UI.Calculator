...
export function PriceSettingsFields({ draft, patch }: PriceSettingsFieldsProps) {
  return (
    <div className="price-modal__body price-modal__body--config">
      ...
      >
        <SectionTitle
          icon={BarChart3}
          description="Controla os multiplicadores-base usados antes dos pacotes e regras especiais."
        >
      ...
      >
        <SectionTitle
          icon={Layers}
          description="Define o peso unitário de cada serviço monitorado na composição do valor mensal."
        >
          Serviços por tipo (unitário × volume)
        </SectionTitle>
      ...
      >
        <SectionTitle
          icon={RadioTower}
          description="Valores fixos para cobertura de TV e rádio por abrangência contratada."
        >
          Broadcast fixo
        </SectionTitle>
      ...
      >
        <SectionTitle
          icon={FileBarChart}
          description="Custos extras para entregas analíticas recorrentes incluídas na proposta."
        >
          Relatórios
        </SectionTitle>
        <div className="price-modal__grid2">
      ...
      >
        <SectionTitle
          icon={Newspaper}
          description="Regras complementares e serviços avulsos que afetam o preço final da proposta."
        >
          Adicionais e regras
        </SectionTitle>
        <div className="price-modal__grid2">
