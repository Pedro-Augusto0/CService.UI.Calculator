/**
 * Logotipo WhatsApp (marca). Lucide não inclui este pictograma;
 * usa `currentColor` para herdar o tom do contexto (ex.: avatar verde).
 */
export function WhatsAppIcon({
  ...
  size?: number
  className?: string
  /** Ignorado; mantido para compatibilidade com ícones Lucide em cartões. */
  strokeWidth?: number
}) {
  return (
    <svg
