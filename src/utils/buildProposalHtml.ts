...
<head>
  ...
  <style>
    body { font-family: "Montserrat", "Segoe UI", "Helvetica Neue", Arial, sans-serif; font-optical-sizing: auto; margin: 0; padding: 32px; background: #f8fafc; color: #0f172a; line-height: 1.5; }
    .wrap { max-width: 800px; margin: 0 auto; background: #fff; border-radius: 5px; padding: 32px; border: 1px solid #e2e8f0; }
    ...
    .final { margin-top: 24px; padding: 20px; background: #e8f0ff; border-radius: 5px; border: 1px solid #bfdbfe; text-align: center; }
